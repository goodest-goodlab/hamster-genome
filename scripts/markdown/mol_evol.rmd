...
pho_mg_data = read.csv("../../data/mol-evol/phodopus-5spec-mg94.csv", header=T, comment.char="#")
...
mus_mg_data = read.csv("../../data/mol-evol/mus-4spec-mg94.csv", header=T, comment.char="#")
...
```{r fig26, warning=FALSE, out.width="100%", fig.align="center"}
